...
func TestEval(t *testing.T) {
	cases := [...]struct {
		...
		{desc: "or two bools - true", input: "(or true t)", successValueType: VAR_BOOL, successValue: true},
		...
		{desc: "nor two bools - false", input: "(nor true t)", successValueType: VAR_BOOL, successValue: false},
		{desc: "and two bools - true", input: "(and true t)", successValueType: VAR_BOOL, successValue: true},
		{desc: "and two bools - false", input: "(and 0 1)", successValueType: VAR_BOOL, successValue: false},
		{desc: "nand two bools - true", input: "(nand 0 1)", successValueType: VAR_BOOL, successValue: true},
		...
		{desc: "xor two bools - false", input: "(xor false 0)", successValueType: VAR_BOOL, successValue: false},
		{desc: "xnor two bools - true", input: "(xnor f 0)", successValueType: VAR_BOOL, successValue: true},
		{desc: "xnor two bools - false", input: "(xnor 0 t)", successValueType: VAR_BOOL, successValue: false},
