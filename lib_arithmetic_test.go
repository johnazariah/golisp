...
func TestAdd(t *testing.T) {
	tests := [...]struct {
	...
	}{
		{
			...
			input: []Variant{
				{VariantType: VAR_INT, VariantValue: 1},
			},
		...
		},
		{
			...
			input: []Variant{
				...
				{VariantType: VAR_INT, VariantValue: 3},
				{VariantType: VAR_INT, VariantValue: 4},
			},
...
func TestDivide(t *testing.T) {
	tests := [...]struct {
		...
		},
		{
			desc: "float / int value",
			input: []Variant{
				{VariantType: VAR_FLOAT, VariantValue: 6.28},
				{VariantType: VAR_INT, VariantValue: 2},
			},
			expected: Variant{VariantType: VAR_FLOAT, VariantValue: float64(3.14)},
		},
		{
			...
			input: []Variant{
				{VariantType: VAR_FLOAT, VariantValue: 6.28},
				{VariantType: VAR_INT, VariantValue: 0},
			},
...
func TestPower(t *testing.T) {
	tests := [...]struct {
		...
		},
		{
			...
			input: []Variant{
				{VariantType: VAR_FLOAT, VariantValue: 3.14},
				{VariantType: VAR_FLOAT, VariantValue: 2},
			},
			expected: Variant{VariantType: VAR_FLOAT, VariantValue: float64(9.8596)},
		},
		{
		...
		},
		{
			desc: "int ^ int value",
			input: []Variant{
				{VariantType: VAR_FLOAT, VariantValue: 3},
				{VariantType: VAR_INT, VariantValue: 2},
			},
